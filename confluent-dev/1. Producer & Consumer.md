...
Klien Kafka Go didasarkan pada library C. Jadi, pengaturan tanda CGO_ENABLED=1 akan memungkinkan Go untuk menggunakan library C untuk klien Kafka. Untuk C compiler, download. Di terminal MSYS2, jalankan command berikut untuk instalasi paket mingw-w64-x86_64-toolchain, yang menyertakan kompiler GCC:
