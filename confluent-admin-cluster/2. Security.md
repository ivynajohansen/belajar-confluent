...
keytool -importkeystore -srckeystore /root/belajar-confluent/ssl/confluent-apac-ivy.p12 -srcstoretype PKCS12 -destkeystore confluent-apac-ivy-keystore.pkcs12 -deststoretype PKCS12
```
