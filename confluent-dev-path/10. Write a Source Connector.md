...
Jika connect-1 adalah leader, kita akan melihat penundaan hingga 5 menit untuk rebalance, karena pengaturan default untuk scheduled.rebalance.max.delay.ms adalah 5 menit. Pada kasus ini, connect-2 adalah leader.
